...
const FeaturedProjectItem: FunctionComponent<{ project: OtherProject }> = ({
  ...
  return (
    <div className="flex flex-col h-[520px] md:h-[500px] w-full md:w-[400px] grid-item bg-white shadow-lg dark:shadow-none dark:bg-tertiary rounded-xl overflow-hidden hover:-translate-y-1 duration-200 transition-all cursor-pointer">
      <Image
      ...
      <div className="h-[320px] md:h-[300px] flex flex-col justify-between px-8 py-10">
        <h1 className="mb-4 text-lg font-bold text-primaryDark dark:text-primary transition-all duration-300">
          {name}
        </h1>
